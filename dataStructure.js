...
// 		if (!isNaN(curr)) {
// 			var pre = numArr.length - 1 >= 0 ? numArr[numArr.length - 1] : -1;
// 			if (pre + 1 === curr || numArr.length === 0) {
// 				numArr.push(curr);
// 				continue;
// 			}
// 		} 
//         max = numArr.length >= max.length ? numArr.join('') : max;
//         numArr = [];
// 	}
...
// // 是否有同样字符
// function compareSimilarStr(a, b) {
...
window.addEventListener('DOMContentLoaded', function() {
    console.log('data DOMContentLoaded');
})
